...
# --- Custom header with logo on the right ---
st.markdown('''
<style>
.custom-header-box {
    display: flex;
...
@media (max-width: 700px) {
    .custom-header-title { font-size: 2rem; }
    .custom-header-box { flex-direction: column; align-items: flex-start; padding: 18px 12px; }
    .custom-header-logo { height: 40px; margin-left: 0; margin-top: 10px; }
}
</style>
<div class="custom-header-box">
  <div class="custom-header-title">
    <img src="https://img.icons8.com/color/96/phone.png" height="48" style="margin-right:12px;vertical-align:middle;"/>
    Telecom Fraud Detection
  </div>
  <img class="custom-header-logo" src="https://upload.wikimedia.org/wikipedia/commons/6/6b/Telefonica_2021_logo.svg" alt="Telecom Logo" />
</div>
''', unsafe_allow_html=True)
